function out = mucalib_Pmu(z,h,Rc,SPhi,nucl10,nucl26,nucl14,consts)
...
% 
% syntax out = mucalib_Pmu(z,h,Rc,SPhi,nucl10,nucl26,nucl14,consts)
% 
% out.P_fast10   without sigma0!!
% out.P_neg10    without fstar!!
% out.P_fast26   without sigma0!!
% out.P_neg26    without fstar!!
% out.P_fast14   without sigma0!!
% out.P_neg14    without fstar!!
%
...
Rz = interp1(RTemp,SFmu,z,'extrap'); % extrapolation to enable z = 0
...
%	fstar_nu14 = consts.fstar14nu;
	...
	% fast muon production
	P_fast14 = phi.*Beta.*(Ebar.^aalpha).*Natoms14; % without sigma0nu14 !!
	
	% negative muon capture
	P_neg14 = R.*k_negpartial14; % without fstar_nu14 !!
end
